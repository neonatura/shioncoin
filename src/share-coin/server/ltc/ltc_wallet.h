...
#ifndef __LTC_WALLET_H__
#define __LTC_WALLET_H__

extern CScript LTC_COINBASE_FLAGS;

class LTCWallet : public CWallet
{
  public:
    LTCWallet() : CWallet(LTC_COIN_IFACE, "ltc_wallet.dat") { };  
