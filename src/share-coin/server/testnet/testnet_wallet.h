...
#ifndef __TESTNET_WALLET_H__
#define __TESTNET_WALLET_H__
...
extern CScript TESTNET_COINBASE_FLAGS;

class TESTNETWallet : public CWallet
{
	public:
		TESTNETWallet() : CWallet(TESTNET_COIN_IFACE, "testnet_wallet.dat") { };  
...
extern TESTNETWallet *testnetWallet;
...
#endif /* ndef __TESTNET_WALLET_H__ */
