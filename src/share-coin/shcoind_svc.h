...
/*
 * Define these macros as appropriate to configure nutc_srv.c for your service.
 * Note that most of this only applies to Windows NT, for communication with
...
/*******************
 * NECESSARY MACROS
 * The following are the macros that must be defined in order for 
...
#define SRV_DISPLAY_NAME	"Share Coin"
