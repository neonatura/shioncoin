...
const ApiItems& shapi_api_faucet_send(int ifaceIndex, string strAccount, shjson_t *params, string& strError, uint160 hColor)
{
...
const ApiItems& shapi_api_faucet_recv(int ifaceIndex, string strAccount, shjson_t *params, string& strError, uint160 hColor)
{
	static ApiItems items;
...
{
	string strFaucet("faucet");
	return (shapi_api_account_txlist(ifaceIndex, strFaucet, params));
}
