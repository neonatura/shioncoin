...
typedef struct
{
    ...
    shmpi d;              /*!<  secret signature key          */
    ecp_point Q;        /*!<  public signature key          */
    shmpi r;              /*!<  first integer from signature  */
    shmpi s;              /*!<  second integer from signature */
}
ecdsa_context;
 ...
 */
int ecdsa_sign( ecp_group *grp, shmpi *r, shmpi *s,
                const shmpi *d, const unsigned char *buf, size_t blen,
 ...
 *                  or a POLARSSL_ERR_ECP_XXX or POLARSSL_MPI_XXX error code
 */
int ecdsa_sign_det( ecp_group *grp, shmpi *r, shmpi *s,
                    const shmpi *d, const unsigned char *buf, size_t blen,
                    md_type_t md_alg );
...
int ecdsa_verify( ecp_group *grp,
                  ...
                  const ecp_point *Q, const shmpi *r, const shmpi *s);
