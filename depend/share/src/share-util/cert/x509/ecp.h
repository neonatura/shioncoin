...
typedef struct
{
    shmpi X;          /*!<  the point's X coordinate  */
    shmpi Y;          /*!<  the point's Y coordinate  */
    shmpi Z;          /*!<  the point's Z coordinate  */
}
ecp_point;
 ...
 * Otherwise, it must point to a function that takes an shmpi in the range
...
typedef struct
{
    ...
    shmpi P;              /*!<  prime modulus of the base field               */
    shmpi A;              /*!<  1. A in the equation, or 2. (A + 2) / 4       */
    shmpi B;              /*!<  1. B in the equation, or 2. unused            */
    ecp_point G;        /*!<  generator of the (sub)group used              */
    shmpi N;              /*!<  1. the order of G, or 2. unused               */
    size_t pbits;       /*!<  number of bits in P                           */
    size_t nbits;       /*!<  number of bits in 1. P, or 2. private keys    */
    unsigned int h;     /*!<  internal: 1 if the constants are static       */
    int (*modp)(shmpi *); /*!<  function for fast reduction mod P             */
 ...
 * Either change them in config.h or define them on the coshmpiler command line.
 * \{
 */
...
int ecp_mul( ecp_group *grp, ecp_point *R,
             const shmpi *m, const ecp_point *P,
...
/**
 * \brief           Check that an shmpi is a valid private key for this curve
 *
 ...
 *                  ecdh_context of ecdsa_context.
 */
int ecp_check_privkey( const ecp_group *grp, const shmpi *d );
 ...
 *                  ecdh_context of ecdsa_context.
 */
int ecp_gen_keypair( ecp_group *grp, shmpi *d, ecp_point *Q,
